...
export function NewAffiliateForm({ error }: { error?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Tipo de Representante Select (Styled properly for high contrast) */}
      <div>
        <label style={labelStyle}>Tipo de Representante</label>
        <select
          name="type"
          value={type}
        ...
        <>
          <div>
            ...
            <input
              ...
              placeholder="Ex: sua cidade em Luzes"
              style={inputStyle}
            />
          </div>
          <div>

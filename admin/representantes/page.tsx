...
import { RepresentanteManager } from "./RepresentanteManager";
  ...
  return (
    <div style={{ padding: "32px 40px" }}>
      <div style={{ maxWidth: "1100px" }}>
        ...
        >
          <div>
            <h1 style={{ fontSize: "22px", fontWeight: 700, marginBottom: "4px" }}>Representantes</h1>
          ...
          <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
            ...
            >
              <span style={{ fontSize: "18px" }}>+</span> Adicionar Representante
            </Link>
          </div>
        </div>

        <RepresentanteManager data={affiliatesData} />
      </div>
    </div>
  );
}

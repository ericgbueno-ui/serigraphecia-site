...
export default async function AffiliateCashPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const affiliateLink = `https://seudominio.com.br/${affiliate.code.toLowerCase()}`;
    ...
    <div style={{ padding: "32px 40px" }}>
      <div style={{ maxWidth: "1180px" }}>
        ...
        <div style={{ ...card, padding: 0, overflow: "hidden", marginBottom: "24px" }}>
          ...
          >
            <div>
              <h2 style={{ fontSize: "15px", fontWeight: 700 }}>Agendamentos do representante</h2>
              <p style={{ fontSize: "12px", color: "var(--muted)", marginTop: "2px" }}>
                Todas as agendamentos associadas ao código {affiliate.code}.
              </p>
            </div>
          </div>
          ...
          {bookings.length === 0 ? (
            ...
            >
              Nenhuma agendamento associada a este representante ainda.
            </div>
          ) : (

            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{
                  ...
                  {last
                    ? `${last.role === "assistente" ? "Assistente: " : ""}${last.content}`
                    : "Sem mensagens"}
                </p>
              </div>
            </button>
...
function MessageBubble({ msg }: { msg: Interaction }) {
  const isAssistente = msg.role === "assistente";
  return (
    <div style={{
      display: "flex", flexDirection: "column",
      alignItems: isAssistente ? "flex-end" : "flex-start",
      marginBottom: 4,
    }}>
      <div style={{
        maxWidth: "72%", padding: "9px 13px", borderRadius: isAssistente ? "16px 4px 16px 16px" : "4px 16px 16px 16px",
        background: isAssistente ? "rgba(201,168,76,0.18)" : "rgba(255,255,255,0.07)",
      ...
      <span style={{
        ...
        paddingLeft: isAssistente ? 0 : 4, paddingRight: isAssistente ? 4 : 0,
      }}>
        {fmtTime(msg.createdAt)}
        {isAssistente && msg.aiEngine ? ` · ${msg.aiEngine.split("/")[0]}` : ""}
      </span>
    </div>
  );
}
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0, flexWrap: "wrap", justifyContent: "flex-end" }}>
          ...
          {/* Ver agendamento */}
          {booking && (
            <Link href={`/admin/agendamentos/${booking.id}`} title="Ver agendamento" style={{
              padding: "6px 10px", borderRadius: 8, fontSize: 16, textDecoration: "none",

...
export default function NovoProfissionalClient() {
    ...
    return (
      <div className="p-6 md:p-10 text-white font-sans flex flex-col items-center justify-center min-h-[60vh]">
        <div className="bg-[#111] border border-white/10 p-8 md:p-12 rounded-3xl max-w-lg w-full text-center shadow-2xl flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold mb-4">Profissional Cadastrado!</h1>
          <p className="text-white/60 mb-8 leading-relaxed">
            O profissional foi adicionado e já está Aprovado no sistema.
          </p>
          <Link
  ...
  return (
    <div className="p-6 md:p-10 text-white font-sans">
      <div className="max-w-3xl mx-auto">
        <Link href="/admin/profissionais" className="text-white/50 hover:text-white mb-6 flex items-center gap-1 transition-colors text-sm w-fit">
          <ChevronLeft size={16} /> Voltar
        </Link>
        
        <h1 className="text-2xl font-bold text-white mb-2">Cadastrar Profissional Manualmente</h1>
        <p className="text-sm text-white/50 mb-8">
          Preencha os dados do novo profissional parceiro. Ele entrará no sistema automaticamente como Aprovado. O aceite dos termos será exigido no primeiro login dele (em breve).
        </p>
        ...
        <form onSubmit={handleSubmit} className="bg-[#111] border border-white/5 rounded-[24px] p-6 md:p-10 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            {/* Informações de Recurso/Especialidade */}
            <div className="md:col-span-2 mt-4">
              <h3 className="text-xs font-bold text-white/40 uppercase tracking-widest mb-4">Recurso / Especialidade</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-white/70">Especialidade / Recurso Utilizado *</label>
                  <input
                    type="text"
                    name="carModel"
                    required
                    ...
                    onChange={handleChange}
                    className="bg-black border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-white/30 transition-colors"
                    placeholder="Ex: Vendas, Estética Facial, Mecânica Geral"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-white/70">Desde (Ano) *</label>
                  <input
                    type="text"
                    name="carYear"
                    required
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-white/70">Detalhe (opcional)</label>
                  <input
                    type="text"
                    name="carColor"
                    required
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-white/70">Identificador Interno (opcional)</label>
                  <input
                    type="text"
                    name="carPlate"
                    required
                    ...
                    placeholder="Ex: Código interno ou matrícula"
                  />
                </div>
                <div className="flex flex-col gap-1.5 md:col-span-2 mt-2">
                  <label className="flex items-center gap-3 cursor-pointer p-4 rounded-xl border border-white/10 bg-black hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-white">Disponibilidade Especial ⚡</span>
                    </div>
                  </label>
                </div>
            ...
            <div className="md:col-span-2 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5 md:col-span-2">
                  <label className="text-sm font-medium text-white/70">Registro Profissional <span className="text-white/30 text-xs font-normal">(Opcional)</span></label>
                  <input
                    type="number"
                    name="cadastur"
                    ...
                    onChange={handleChange}
                    className="bg-black border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-white/30 transition-colors"
                    placeholder="Ex: registro de classe, se aplicável"
                  />
                </div>
              </div>
            </div>

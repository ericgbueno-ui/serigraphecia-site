  ...
  return (
    <div>
      ...
      >
        ...
        >
          {[
            { icon: "👑", label: "Embaixador", desc: "transfer ida e volta + citytour 2 dias ou Bento", color: "#f97316" },
            { icon: "⭐", label: "VIP", desc: "transfer ida e volta + citytour", color: "#c9a84c" },
            { icon: "🤎", label: "Regular", desc: "transfer ida e volta", color: "#3ecf8e" },
          ].map((c) => (
      ...
      <div style={{ ...cardStyle, overflow: "hidden", padding: 0 }}>
        ...
        >
          ...
          >
            Última viagem {getSortIndicator("date")}
          </button>
          <button
        ...
        {sorted.map((c, i) => {
          ...
          // Busca se alguma reserva do cliente tem indicação de afiliado associado
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: 10, color: "var(--muted)" }}>
                  {brl(Math.round(c.totalCents / c.bookings.length))} / viagem
                </p>
              </div>

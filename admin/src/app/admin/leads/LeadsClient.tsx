...
function formatSource(src: string) {
  ...
  if (src === "whatsapp") return "🤖 Jolie (WhatsApp)";
...
export default function LeadsClient({ leads, total, page, perPage, statusFilter, statMap, convertedPhones, monthlyStats, totalAllLeads, sourceBreakdown }: Props) {
  ...
  // Conversão real: leads cujo telefone bate com reserva confirmada
      ...
      <div style={{ maxWidth: 1250, margin: "0 auto", padding: isMobile ? "16px 12px" : "24px 24px" }}>
        ...
        <div style={{
          ...
          {[
            ...
            { label: "Convertidos ✓", value: convertedPhones.length, color: "#c9a84c", sub: "reservas confirmadas" },
            { label: "Taxa de Conv.", value: `${conversionRate}%`, color: "#22c55e", sub: "leads → reserva real" },
          ].map((kpi) => (
        ...
        >
          <div>
            <p style={{ fontWeight: 700, fontSize: 14, color: "#c9a84c", marginBottom: 2 }}>
              💬 Ver Histórico de Conversas da Jolie
            </p>
                          ...
                          >
                            ...
                            {lastMsg && (
                              <p style={{
                                ...
                                <strong style={{ color: lastMsg.role === "jolie" ? "#c9a84c" : "#3b82f6" }}>
                                  {lastMsg.role === "jolie" ? "Jolie" : "Cliente"}:
                                </strong>{" "}
                    ...
                    >
                      ...
                      {last && (
                        <div style={{
                          ...
                          borderLeft: `3px solid ${last.role === "jolie" ? "#c9a84c" : "#3b82f6"}`,
                        }}>
                          <p style={{ fontSize: 12, color: last.role === "jolie" ? "#c9a84c" : "rgba(255,255,255,0.75)", marginBottom: 2 }}>
                            <strong>{last.role === "jolie" ? "Jolie" : "Cliente"}:</strong> {last.content.slice(0, 100)}...
                          </p>
                        </div>
                      )}
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                  <thead>
                    <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.06)", background: "rgba(255,255,255,0.01)" }}>
                      ...
                      <th style={{ padding: "12px 16px", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--muted)" }}>Origem & Viagem</th>
                        ...
                        >
                          ...
                          <td style={{ padding: "16px" }}>
                            <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                              ...
                              {lead.origin && (
                                <span style={{ fontSize: 10, color: "rgba(255,255,255,0.5)" }}>Viagem: {lead.origin} ➔ {lead.destination || "?"}</span>
                              )}
                              {lead.valueCents && (
                            ...
                            {lastInteraction ? (
                              <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                                <p style={{ fontSize: 12, color: "rgba(255,255,255,0.8)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                  <strong style={{ color: lastInteraction.role === "jolie" ? "#c9a84c" : "#3b82f6" }}>
                                    {lastInteraction.role === "jolie" ? "Jolie" : "Cliente"}:
                                  </strong>{" "}
            ...
            <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: 20, flex: 1 }}>
              ...
              <form onSubmit={handleSaveDetails} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", gap: 10 }}>
                  <div>
                    <label style={{ display: "block", fontSize: 11, color: "var(--muted)", marginBottom: 6, fontWeight: 600 }}>Data da Viagem</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: 11, color: "var(--muted)", marginBottom: 6, fontWeight: 600 }}>Passageiros</label>
                    <input
                      type="number"
                      min="1"
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  ...
                  <div>
                    ...
                    >
                      <option value="whatsapp">🤖 Jolie (WhatsApp)</option>
                        ...
                        <div>
                          <p style={{ fontSize: 12, fontWeight: 700, color: "#fff", margin: 0 }}>
                            ⚙️ {evt.type === "page_view" ? "Visualizou página" : 
                               ...
                               evt.type === "response" ? "Respondeu à Jolie" : evt.type}
                          </p>

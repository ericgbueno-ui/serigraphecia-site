...
export const metadata = {
  title: "Fechamento Anual | Admin Multi Trip",
      ...
      <div>
        <div className="caixa-header">
          <div className="caixa-title-block">
            ...
            <p>Relatório anualizado de reservas, recebimentos e lucros brutos mês a mês.</p>
          </div>
        ...
        >
          <div className="caixa-month-grid">
            {["Período", "Reservas", "Faturamento", "Recebido", "Lucro Bruto", "A Receber", "Cobertura"].map(
              (h) => (
                <span
                  key={h}
                  className={h === "Reservas" || h === "A Receber" ? "caixa-col-hide" : ""}
                  style={{
                    fontSize: "10px",
                    fontWeight: 700,

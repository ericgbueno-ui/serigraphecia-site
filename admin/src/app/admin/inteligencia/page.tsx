...
export default function InteligenciaPage() {
  ...
  async function send(question: string) {
    ...
    try {
      const res = await fetch("/api/admin/jolie-analytics", {
        method: "POST",
      ...
      setMessages((prev) => {
        ...
        updated[updated.length - 1] = {
          role: "assistant",
          content: `Erro ao conectar com a Jolie: ${err.message}`,
        };
        return updated;
      });
    } finally {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <span style={{ fontWeight: 700, fontSize: 15 }}>🧠 Jolie Inteligência</span>
            <span style={{
          ...
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: 20, fontWeight: 700, color: "#c9a84c", marginBottom: 8 }}>
                Olá, Eric. Sou a Jolie.
              </h2>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", lineHeight: 1.6, maxWidth: 420, margin: "0 auto" }}>
                Tenho acesso aos dados reais do sistema — leads, reservas, faturamento e campanhas.
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <div style={{
            ...
            <textarea
              ...
              placeholder="Pergunte sobre leads, reservas, campanhas…"
              rows={1}
              disabled={loading}
              style={{

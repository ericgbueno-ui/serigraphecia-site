...
const META_TEMPLATES = [
  {
    id: "multitrip_lembrete_pre_viagem",
    label: "🗓️ Lembrete Pré-Viagem",
    categoria: "Utilidade",
    preview: `Olá, [Nome]! 🤎 Aqui é a Jolie da Multi Trip.\n\nSua viagem está chegando! Lembre-se de confirmar seus dados e ter o contato do seu motorista em mãos.\n\nQualquer dúvida, estou aqui. Boa viagem! ✈️`,
    hasVar: true,
  },
  {
    id: "multitrip_avaliacao_google",
    label: "⭐ Avaliação Google",
    categoria: "Marketing",
    preview: `Olá, [Nome]! 🤎 Aqui é a Jolie da Multi Trip.\n\nEspero que sua viagem tenha sido incrível! Sua opinião nos ajuda muito a continuar evoluindo.\n\nDeixe sua avaliação aqui (leva menos de 1 minuto):\n👉 https://g.page/r/CflNFvOwC_7vEAE/review\n\nMuito obrigada! 🙏`,
    hasVar: true,
  },
  {
    id: "multitrip_reativacao_cliente",
    label: "🔄 Reativação de Cliente",
    categoria: "Marketing",
    preview: `Olá, [Nome]! 🤎 Aqui é a Jolie da Multi Trip.\n\nSentimos sua falta! Está planejando uma nova viagem para Gramado ou Canela?\n\nTemos datas disponíveis e adoraríamos cuidar de tudo pra você novamente. 🍷✨\n\nMe chama aqui e te passo um orçamento exclusivo!`,
    hasVar: true,
  },
  {
    id: "multitrip_recuperacao_lead",
    label: "💬 Recuperação de Lead",
    categoria: "Marketing",
    preview: `Olá! 🤎 Aqui é a Jolie da Multi Trip.\n\nVi que você consultou sobre transfer para a Serra Gaúcha mas ainda não finalizou.\n\nPosso te ajudar a planejar sua viagem com segurança e conforto. Qual é a data que você tem em mente?\n\n👉 https://multitrip.com.br`,
    hasVar: false,
  },
];
...
const FREE_TEMPLATES = [
  {
    id: "lembrete_pre_viagem",
    label: "🗓️ Lembrete Pré-Viagem",
    text: `Olá! 🤎 Aqui é a Jolie da Multi Trip.\n\nSua viagem está chegando! Lembre-se de confirmar seus dados e ter o contato do seu motorista em mãos.\n\nQualquer dúvida, estou aqui. Boa viagem! ✈️`,
  },
  {
    id: "avaliacao_google",
    label: "⭐ Avaliação Google",

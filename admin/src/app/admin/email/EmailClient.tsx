...
const EMAIL_TEMPLATES = [
  ...
  },
  {
    ...
    subject: "Sentimos sua falta! Está planejando uma nova viagem? 🍷",
    body: `Já faz um tempo desde a sua última viagem com a Multi Trip, e sentimos sua falta!\n\nEstá planejando uma nova visita a Gramado ou Canela? Temos datas disponíveis e adoraríamos cuidar de tudo pra você novamente.\n\nComo cliente especial, você tem prioridade na agenda e às vezes condições exclusivas. ✨`,
  ...
  },
  {
    ...
    body: `Tenho uma novidade que acho que vai te interessar!\n\nEstamos com uma condição especial para transfers na Serra Gaúcha nas próximas semanas.\n\nSe você está pensando em planejar uma viagem para Gramado ou Canela, este pode ser o momento certo. Vagas limitadas!`,
  ...
  },
  {
    ...
    subject: "Transfer privativo na Serra Gaúcha para os clientes da sua agência",
    body: `Olá, tudo bem?

Sou a Rita, co-fundadora da Multi Trip — junto com o Eric, cuidamos de cada detalhe da chegada dos seus clientes na Serra Gaúcha.

Com mais de 10 anos do Eric transportando passageiros nessa rota e o meu olhar no relacionamento e na experiência de cada pessoa que embarca conosco, criamos a Multi Trip com um propósito claro: fazer o que o mercado não fazia — cuidar de verdade desde a chegada.

O transfer do aeroporto é o primeiro contato físico do viajante com a viagem. E a gente faz questão de que esse momento seja inesquecível.

O que entregamos às agências parceiras:
- Experiência de chegada premium — carro exclusivo, atendimento com nome e rosto
- Monitoramento de voo em tempo real (tolerância de 60 min sem custo extra)
- Suporte direto pelo WhatsApp antes, durante e depois da viagem
- Comissão para a agência em cada reserva

Mais de 1.000 transfers realizados. Cadastur ativo. Atendimento todos os dias do ano.
...
export default function EmailClient() {
  ...
  const [jobCtaUrl, setJobCtaUrl] = useState("https://wa.me/5551989129376");
        ...
        <div>
          ...
          {resendReady === false && (
            <div style={{ background: "rgba(96,165,250,0.06)", border: "1px solid rgba(96,165,250,0.2)", borderRadius: "10px", padding: "14px 18px", marginBottom: "20px", fontSize: "12px", color: "var(--muted)", lineHeight: "1.6" }}>
              ...
              <strong style={{ color: "var(--text)" }}>resend.com/domains</strong> para enviar pelo multitrip.com.br.
            </div>
          )}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <input value={subject} onChange={(e) => setSubject(e.target.value)}
                  placeholder="Ex: Sua viagem está chegando! ✈️"
                  style={inputStyle} />
              </div>
              <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                ...
                <div>
                  ...
                  <input value={ctaUrl} onChange={(e) => setCtaUrl(e.target.value)}
                    placeholder="https://multitrip.com.br"
                    style={inputStyle} />
                </div>
              </div>
            </div>
              ...
              <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                {[
                  ...
                  },
                  {
                    ...
                    subject: "Novidades na Multi Trip para sua agência",
                    body: `Olá, tudo bem?\n\nSou a Rita, da Multi Trip. Já nos falamos antes e queria retomar o contato.\n\nTemos novidades para agências parceiras e acredito que pode fazer sentido para o perfil dos seus clientes.\n\nA gente cuida de cada chegada na Serra Gaúcha com carro exclusivo, atendimento direto pelo WhatsApp e monitoramento de voo em tempo real. Nada compartilhado, nada genérico.\n\nPodemos conversar rapidinho?\n\nUm abraço,\nRita e Eric`,
                    ctaText: "Falar pelo WhatsApp",
                    ctaUrl: "https://wa.me/5551989129376",
                  },
                ].map((t) => (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              <div>
                ...
                <input value={jobSubject} onChange={(e) => setJobSubject(e.target.value)}
                  placeholder="Transfer privativo na Serra Gaúcha para os clientes da sua agência"
                  style={inputStyle} />
              </div>
              <div>
                <label style={labelStyle}>Corpo da mensagem</label>
